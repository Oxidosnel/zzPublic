...
//
//    
//    CGContextSelectFont(context, "Georgia", 50, kCFStringEncodingUnicode);
...
//    return image;
        ...
        NSDictionary *attr = @{
                               ...
                               NSForegroundColorAttributeName : [UIColor randomColor]      //设置字体颜色
                               
                               };
        

        
//        [mark drawInRect:CGRectMake(10, h - 32 - 10, 180, 132) withAttributes:attr];        //左下角
//        [mark drawAtPoint:CGPointMake(w/2-text1.length*5, h/2) withAttributes:attr];
        [mark drawAtPoint:CGPointMake(45, h-35) withAttributes:attr];
